...
class inst_adsentries:
    '''
    adsinst (class): Statistics of publications in an Institute
    ...
    def load_inst(self):
        ...
        fname_pub_auth_all = ''.join([self.config['dir_data'], '/',
                                      self.config['fname_pub_auth_all'], '.pk'])
        fname_pub_auth_top = ''.join([self.config['dir_data'], '/',
                                      self.config['fname_pub_auth_top'], '.pk'])
        fname_pub_inst_all = ''.join([self.config['dir_data'], '/',
                                      self.config['fname_pub_inst_all'], '.pk'])
        fname_pub_inst_top = ''.join([self.config['dir_data'], '/',
                                      self.config['fname_pub_inst_top'], '.pk'])
    ...
    def save_inst(self):
        ...
        pickle.dump(pub_auth_all, open(fname_pub_auth_all, 'wb'))
        pickle.dump(pub_auth_top, open(fname_pub_auth_top, 'wb'))
        pickle.dump(pub_inst_all, open(fname_pub_inst_all, 'wb'))
        pickle.dump(pub_inst_top, open(fname_pub_inst_top, 'wb'))
